...
public class PastryController {
    ...
    @PutMapping ("/{id}")
    public PastryResponseDto updatePastry (@PathVariable Long id, @RequestBody PastryRequestDto pastryRequestDto) {
    ...
    public PastryResponseWithIngredientDto addIngredient (@PathVariable Long pastryId, @PathVariable Long ingredientId) {
